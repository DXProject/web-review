...
CREATE TABLE IF NOT EXISTS `reviewDB`.`department` (
  ...
  `type` INT NOT NULL COMMENT '1-机关，2-学院',
...
-- -----------------------------------------------------
-- Table `reviewDB`.`subject_category`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `reviewDB`.`subject_category` ;

CREATE TABLE IF NOT EXISTS `reviewDB`.`subject_category` (
  `id` CHAR(32) NOT NULL COMMENT '',
  `name` VARCHAR(45) NULL COMMENT '',
  `remark` VARCHAR(450) NULL COMMENT '',
  `creator` CHAR(32) NULL COMMENT '',
...
-- -----------------------------------------------------
-- Table `reviewDB`.`discipline_category`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `reviewDB`.`discipline_category` ;

CREATE TABLE IF NOT EXISTS `reviewDB`.`discipline_category` (
  `id` CHAR(32) NOT NULL COMMENT '',
  `name` VARCHAR(45) NULL COMMENT '',
  `is_deleted` TINYINT(1) NULL COMMENT '',
  `creator` CHAR(32) NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `reviewDB`.`project` (
  ...
  `subject_category_id` CHAR(32) NOT NULL COMMENT '课题类别',
  `discipline_category_id` CHAR(32) NOT NULL COMMENT '学科门类',
  `name` VARCHAR(45) NULL COMMENT '',
  ...
  INDEX `fk_project_subjectcategory1_idx` (`subject_category_id` ASC)  COMMENT '',
  INDEX `fk_project_disciplinecategory1_idx` (`discipline_category_id` ASC)  COMMENT '',
  ...
  CONSTRAINT `fk_project_subjectcategory1`
    ...
    REFERENCES `reviewDB`.`subject_category` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_project_disciplinecategory1`
    FOREIGN KEY (`discipline_category_id`)
    REFERENCES `reviewDB`.`discipline_category` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
